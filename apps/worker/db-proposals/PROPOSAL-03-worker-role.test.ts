...
describe('PROPOSAL-03 (WK-08/WK-22/WK-23): worker_role con RLS real', () => {
  ...
  it('worker_role tiene EXACTAMENTE grants sobre {jobs, source_runs, agent_runs} + las 10 tablas de lectura de negocio de 0098 (E6/PROPOSAL-06) + las 2 tablas de huellas de REQ-032 + proposal_sections de REQ-070, ninguna otra', async () => {
    ...
    // REQ-032 (proposal_section_fingerprints/proposal_similarity_flags) y
    // por la migración de REQ-070 (proposal_sections, nodo "Auditor" —
    // `auditar_expediente`/`computeAuditReport` necesita leerla) — ver
