...
| 11 | 2026-09-05 | audit-web-ronda1 → docs/auditoria-1/web.md + capturas (render real Playwright, axe, paridad Restaurantes, honestidad, seguridad, mutación de pruebas) — solo hallazgos | model="sonnet" | pendiente | en curso |
